...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			$productByCode = $db_handle->runQuery("SELECT * FROM girl WHERE code='" . $_GET["code"] . "'");
...
<link href="girl.css" type="text/css" rel="stylesheet"/>
</HEAD>
<BODY>
...
<div id="product-grid">
	...
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM girl ORDER BY id ASC");
